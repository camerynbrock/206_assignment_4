...
In 2012, mean lobster size in nonMPA sites was larger than in MPA sites by about 7.5mm (t test (`r round(mpa_2012_ttest$parameter, 0)`), t = `r round(mpa_2012_ttest$statistic, 3)`, p-value =`r round(mpa_2012_ttest$p.value, 4)`). In 2018, mean lobster size was larger in MPAs than in nonMPAs by about 4mm (t test (`r round(mpa_2018_ttest$parameter, 0)`) p-value = `r round(mpa_2018_ttest$p.value, 10)`). Between 2012 and 2018, mean lobster size in MPA sites increased by about 10mm (t test (`r round(mpa_size_ttest$parameter, 0)`) p-value = `r round(mpa_size_ttest$p.value, 10)`)
